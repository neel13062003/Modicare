...
# print(user_input)
#user_input = 'Wipes'
#user_input = sys.argv[1:]  # get the list of products from command line arguments
...
sorted_similar_products = sorted(similar_products, key=lambda x:x[1], reverse=True)[1:3]
