                    ...
                    <tbody>
                        <?php
                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' .$Id. '</td> 
                                    <td><img src="/DBE/img/person-' .$Id. '.jpg" alt="image for this user" onError="this.src =\'/DBE/img/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' .$username. '</td>
                                    <td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="partials/_userManage.php" method="post">
			  ...
			  <div class="form-group">
                  <b><label for="mca">MCA:</label></b>
                  <input type="mca" class="form-control" id="mca" name="mca" placeholder="Enter Your MCA No." required>
              </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
                  <b><label for="ava">Availibilty:</label></b>
                  <input type="ava" class="form-control" id="ava" name="ava" placeholder="Enter Your Availibilty" required>
              </div>
			  <div class="form-group">
                  <b><label for="code">Code:</label></b>
                  <input type="code" class="form-control" id="code" name="code" placeholder="Enter Your Seperate Code" required>
              </div>
        ...
        <div class="modal-body">
            ...
            <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                ...
                <div class="form-group col-md-4">
                    <img src="/DBE/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/DBE/img/profilePic.jpg'">
                    <form action="partials/_userManage.php" method="post">
                        <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
            ...
            <form action="partials/_userManage.php" method="post">
				...
				<div class="form-group">
                    <b><label for="mca">MCA:</label></b>
                    <input type="mca" class="form-control" id="mca" name="mca" value="<?php echo $mca; ?>" required>
                </div>
				...
				<div class="form-group">
                    <b><label for="ava">Availibilty:</label></b>
                    <input type="ava" class="form-control" id="ava" name="ava" value="<?php echo $ava; ?>" required>
                </div>
				
				<div class="form-group">
                    <b><label for="code">Code:</label></b>
                    <input type="code" class="form-control" id="code" name="code" value="<?php echo $code; ?>" required>
                </div>
                <div class="form-group row my-0">
                    <div class="form-group col-md-6 my-0">
                        <b><label for="phone">Phone No:</label></b>
