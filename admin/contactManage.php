				...
				<table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        <?php
                            ...
                            if($count==0) {
                              ?><script> document.getElementById("notempty").innerHTML = '<div class="alert alert-info alert-dismissible fade show" role="alert" style="width:100%; margin-top:80px;"> You have not recieve any message!	</div>';
