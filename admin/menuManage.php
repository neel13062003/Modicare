			...
			<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
				<div class="card mb-3">
					...
					<div class="card-body">
                            ...
                            <div class="form-group">
								<label class="control-label">DP Price</label>
								<input type="number" class="form-control" name="price" required min="1">
							</div>	
							<div class="form-group">
								<label class="control-label">BV</label>
								<input type="float" class="form-control" name="price1" required min="1">
							</div>
							<div class="form-group">
								<label class="control-label">PV</label>
								<input type="float" class="form-control" name="price2" required min="1">
							</div>
							<div class="form-group">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            ...
                                            <td>
                                                <img src="/DBE/img/pizza-'.$pizzaId. '.jpg" alt="image for this item" width="150px" height="150px">
                                            </td>
                                            <td>
                                                <p>Name : <b>' .$pizzaName. '</b></p>
                                                <p>Description : <b class="truncate">' .$pizzaDesc. '</b></p>
                                                <p>DP Price : <b>' .$pizzaPrice. '</b></p>
                                                <p>BV : <b>' .$pizzaPrice1. '</b></p>
                                                <p>PV : <b>' .$pizzaPrice2. '</b></p>
                                            </td>
...
<?php 
    ...
    while($pizzaRow = mysqli_fetch_assoc($pizzaResult)){
        ...
        $pizzaPrice1 = $pizzaRow['pizzaPrice1'];
        $pizzaPrice2 = $pizzaRow['pizzaPrice2'];
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/DBE/img/pizza-<?php echo $pizzaId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
			...
			<div class="text-left my-2 row">
				<div class="form-group col-md-6">
                	<b><label for="price">DP Price</label></b>
                	<input class="form-control" id="price" name="price" value="<?php echo $pizzaPrice; ?>" type="number" min="1" required>
				</div>
				<div class="form-group col-md-6">
                	<b><label for="price1">BV</label></b>
                	<input class="form-control" id="price1" name="price1" value="<?php echo $pizzaPrice1; ?>" type="float" min="1" required>
				</div>
				<div class="form-group col-md-6">
                	<b><label for="price2">PV</label></b>
                	<input class="form-control" id="price2" name="price2" value="<?php echo $pizzaPrice2; ?>" type="float" min="1" required>
				</div>
				<div class="form-group col-md-6">
