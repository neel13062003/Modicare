                                        ...
                                        echo '<tr>
                                                <th scope="row">
                                                    ...
                                                    <div class="ml-3 d-inline-block align-middle">
                                                        ...
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle"></a></h5><span class="text-muted font-weight-normal font-italic d-block">BV = ' .$pizzaPrice1. '</span>
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle"></a></h5><span class="text-muted font-weight-normal font-italic d-block">PV = ' .$pizzaPrice2. '</span>
                                                        <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle"></a></h5><span class="text-muted font-weight-normal font-italic d-block">total = ' .$total. '</span>
                                                    </div>
                                                    </div>
                                                </th>
