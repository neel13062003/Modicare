...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	/*AA below line lakhs to apde viewcart ma where thi target karine singup mathi data lavi saksu*/
    ...
    if(isset($_POST['checkout'])) {
        ...
        if (password_verify($password, $passRow['password'])){ 
            $sql = "INSERT INTO `orders` (`username1`,`userId`,`code`, `mca`,`address`, `zipCode`, `phoneNo`, `amount`, `paymentMode`, `orderStatus`, `orderDate`) VALUES ('$username1' ,'$userId','$code','$mca' ,'$address', '$zipcode', '$phone', '$amount', '0', '0', current_timestamp())";
            $result = mysqli_query($conn, $sql);
