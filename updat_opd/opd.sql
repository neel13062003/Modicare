...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 10:07 PM
...
(23, 61, 'Magan Bhai', 7845963210, 10, '2022-03-16 17:07:56');
...
INSERT INTO `giftdetails` (`id`, `orderId`, `gift`, `datetime`) VALUES
(1, 61, 'FaceWash ', '2022-03-16 17:08:07'),
(2, 62, 'Brush ', '2022-03-15 01:01:36'),
(3, 63, 'Baby Soap', '2022-03-15 02:28:11'),
(4, 69, 'Baby Soap', '2022-03-16 21:56:13');
...
INSERT INTO `orders` (`orderId`, `username1`, `userId`, `code`, `address`, `zipCode`, `phoneNo`, `amount`, `paymentMode`, `giftStatus`, `payStatus`, `orderStatus`, `orderDate`) VALUES
(61, 'hetshah', 28, 'dim123', '59,SHREEJICHARAN SOCIETY, OPP RELIANCE PETROL PUMP', 383325, 7874866543, 2038, '0', '1', '1', '1', '2022-03-14 13:59:57'),
(62, 'hetshah', 28, 'dim123', '59,SHREEJICHARAN SOCIETY, OPP RELIANCE PETROL PUMP', 383325, 7874866543, 472, '0', '1', '1', '0', '2022-03-14 17:43:39'),
(63, 'ayushi', 29, 'dim123', 'Opp Elta Tower, Rajkot', 756320, 7016211655, 3784, '0', '1', '1', '0', '2022-03-15 02:27:06'),
(66, 'hetshah', 28, 'pur123', 'Shreejicharan society, opp relaince petrol pump', 383325, 7874866543, 32, '0', '0', '0', '0', '2022-03-15 05:09:17'),
(67, 'ayushi', 29, 'dim123', '59,SHREEJICHARAN SOCIETY, OPP RELIANCE PETROL PUMP', 383325, 7874866543, 6085, '0', '0', '0', '0', '2022-03-16 19:27:21'),
(68, 'ayushi', 29, 'dim123', 'Shreejicharan society, opp relaince petrol pump', 383325, 7874866543, 32, '0', '0', '0', '0', '2022-03-16 21:19:04'),
(69, 'DHRUV', 16, 'dim123', '59,SHREEJICHARAN SOCIETY, OPP RELIANCE PETROL PUMP', 383325, 7874866543, 3103, '0', '1', '2', '0', '2022-03-16 21:54:17'),
(70, 'DHRUV', 16, 'pur123', '59,SHREEJICHARAN SOCIETy, OPP RELIANCE PETROL PUMP', 383325, 7874866543, 2258, '0', '0', '0', '0', '2022-03-16 21:57:29');
...
(3, 61, 3000, '2022-03-16 22:21:40'),
(4, 62, 472, '2022-03-14 17:44:24'),
(5, 63, 3700, '2022-03-15 02:27:41'),
(6, 69, 3000, '2022-03-16 21:55:15');
...
(21, 'DevShah', 'Dev', 'Shah', 'dev@gmail.com', 9874563210, '0', '$2y$10$8WninYrxKDyQBAsaO5qHveeoiKl3BwSSgARVK2Ddab3xw7TO/ETZy', '2022-03-13 13:56:45'),
(25, 'dimplesoni', 'dimple', 'soni', 'dimplensoni2111@gmail.com', 7041925432, '1', '$2y$10$so3LGbfl62Qu/kuUva263OLaZ23t.nS1ZkxX1mm6y6UBVqTYeb9be', '2022-03-13 17:17:53'),
(26, 'purvipopat', 'purvi', 'popat', 'purvi@gmail.com', 7896541230, '1', '$2y$10$qPixxARzsbQvug5i7RwhmetNKFr8NVzYuO0zseXmmwEtrN6ho1PQy', '2022-03-13 17:18:33'),
(27, 'nikipatel', 'niki', 'patel', 'niki@gmail.com', 7894561230, '1', '$2y$10$phluNbHVTH7u8piI/Ikx2.dEpRO/knaP6ctGZTCemflIpAGEC2b3C', '2022-03-13 21:35:35'),
(28, 'hetshah', 'Het', 'Shah', 'het@gmail.com', 7896541230, '0', '$2y$10$TjGAKNmgsS6SdWSWmWnR2O24ntObmr5RLfH/1d4f.2JlTn62F90ZC', '2022-03-14 13:58:29'),
(29, 'ayushi', 'ayushi', 'gusani', 'ayu@gmail.com', 7896541230, '0', '$2y$10$ikBN6Qkervgei2J75SZ.h.Hjanvlttz7wh6fqRb.Y6NSwKerXdza6', '2022-03-15 02:25:43');
...
(145, 165, 12, 16, '2022-03-17 01:49:19'),
(146, 70, 3, 28, '2022-03-17 02:33:15');
...
--
ALTER TABLE `contact`
  MODIFY `contactId` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `deliverydetails`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `orderitems`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orderId` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
...
--
ALTER TABLE `pizza`
  MODIFY `pizzaId` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=567;
...
--
ALTER TABLE `viewcart`
  MODIFY `cartItemId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;
COMMIT;
