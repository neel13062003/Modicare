...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/kalpsoni.jpg);height: 400px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                    ...
                    <div class="contact-box p-4">
                      ...
                      <form action="partials/_manageContactUs.php" method="POST">
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
									...
									placeholder="Enter Your Phone Number" required pattern="[0-9]{10}" value="<?php echo $phone ?>">
                                </div>
                            </div>
                          </div>
                          <div class="col-lg-6">
						  ...
						  <!div class="col-lg-6"> <!value="><!?php echo $code ?">
                            <!div class="form-group mt-3">
                              <!b><!label for="code"><!Add Your Billing Code(Most Imp)><!/label><!/b>
                              <!input class="form-control" id="code" name="code" placeholder="Enter Billing Code" type="text"  required>
                            <!/div>
                          <!/div>
                          <div class="col-lg-12">
                            <div class="form-group mt-4">
                                <textarea class="form-control" id="message" name="message" rows="2" required minlength="3" placeholder="How May We Help You ?"></textarea>
                            </div>
                          </div>
                          <?php if($loggedin){ ?>
                            <div class="col-lg-12">
							...
							<!div class="col-lg-4">
                             <div class="icon-badge-container mx-1" style="padding-left:225px;">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/bg.jpg)">
                          <div class="detail-box p-4">
							...
							<style>
							 ...
							 <h4 class="text-white font-weight-light mb-3 mt-4">
							 <a class="unique" href="http://localhost/DBE/admin/login.php">DP Owner</a></h4>
						    
						    	
							  
                            <div class="round-social light">
                              
							  <a href="https://github.com/neel13062003 " class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
                              
							  <a href="https://www.linkedin.com/in/soni-neel-5b0562204/" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-linkedin"></i></a>
                            
							  <a href="https://www.instagram.com/sonineel1313/" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-instagram"></i></a>
      ...
      <!-- Message Modal -->
      <div class="modal fade" id="adminReply" tabindex="-1" role="dialog" aria-labelledby="adminReply" aria-hidden="">
