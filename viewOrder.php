...
<body>
    ...
    <div class="container" style="min-width:95%;">
        <div class="table-wrapper" id="empty"  >
            <div class="table-title" style="background:black;border-radius:15px;">
                <div class="row" >																																																											
                    <div class="col-sm-4">
            ...
            <table class="table table-striped table-hover text-center" id="NoOrder1" style="min-width:100%;"> 
                <thead style="background:rgb(111 202 203);">
                    <tr>
					    <th>No.</th>
					    <th>Bill Name</th>
                ...
                <tbody><!WHERE `userId`= $userId"><!WHERE `username`=$username">
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)){
							...
							//while($neelrow = mysqli_fetch_assoc($result1)){ 	
